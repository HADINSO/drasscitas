		...
		<form action="" id="manage-appointment">
			...
			<div class="form-group">
				...
				<select class="browser-default custom-select" name="status">
					<option value="0" <?php echo isset($status) && $status == 0 ? "selected" : ''; ?>>Pedido</option>
					<option value="1" <?php echo isset($status) && $status == 1 ? "selected" : ''; ?>>Confirmar</option>
			...
			<div class="col-md-12 text-center">
				<button class="btn-primary btn btn-sm col-md-4">Actualizar</button>
