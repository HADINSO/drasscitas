            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Bienvenido <?php echo $_SESSION['setting_name']; ?></h3>
                        <hr class="divider my-4" />
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="index.php?page=doctors">Buscar asesor</a>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="index.php?page=doctors&sid=<?php echo $row['id'] ?>">
                            ...
                            <div class="portfolio-box-caption">
                                ...
                                <div class="project-category text-white">Ir al asesor</div>
                            </div>
                        </a>
                    </div>
                    <?php endwhile; ?>
